...
export const baisen011 = {
  ...
  log: [
    ...
    {
      role: "user",
      text: "そうね、一応残すかな\nあと動画は最初2分くらいつけわすれてて、ない、それ以降はある",
    },
    {
      role: "user",
      text: "豆：ブラジル S18 No.2 量（焙煎前）：138g 量（焙煎後）：110g 焙煎日：2026/08/07  ■ログ 1ハゼ：6:41（投入から約7:41） 2ハゼ：10:05（投入から約11:05） 終了：14:07（投入から約15:07）  ■メモ ハンドピック前：150g ハンドピック後：138g 除去重量：12g（約8.0%） 焙煎減少率：約20.3%",
    },
    {
      role: "user",
      text: "あー、いいね、苦みの感じが違う、苦いけど甘い感じというか、こっちのほうがおいしいとおもう。スッキリ感もある",
    },
  ],
