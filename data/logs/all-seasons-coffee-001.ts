...
export const allseasonscoffee001 = {
  ...
  log: [
    {
      role: "user",
      text: "そうそう、注文したのがハンドドリップで、前行ったコバートと同じでカウンターに豆がガラス瓶に入れてあって、香りを確認できるようになってる、ここも基本的には浅煎りのフルーティなコーヒーがメインみたい。で、ルワンダの豆を選んでいれてもらった。ハンドドリップしてるとこ見たかったけど、カウンターで後ろ向いてるから見えなかったな。あ、1000円だった。他にもチーズケーキとかプリンとかスイーツがいくつかあったけど、注文せず。",
    },
    {
      role: "user",
      text: "キウイの香りだそうで、なんとなくかいだことあるような気もするけど、どうかなあ。後味がすっきりしてるっていうか、無い、に近いかも。香りがして、酸味も少し感じるけどピタッてなくなる感じ。",
    },
    {
      role: "user",
      text: "飲み手側だねー\n週一で、いつもと違うののみたい、みたいな感じだね",
    },
    {
      role: "user",
      text: "酸味とか香りは、浅煎りいれたときに似たようなの飲んだことがあると思うけど、ここまで後味ピタッとないのは初めてかも。",
    },
    {
      role: "user",
      text: "あー、リセットか、温度が低くなると少し残るかな",
    },
    {
      role: "user",
      text: "ちなみに、豆のカードももらって、\nルワンダ、ルリンド？\nレッドブルボン、アラビカ種\nアナロビックナチュラル？\nキウイ、アプリコット、グローブ",
    },
    {
      role: "user",
      text: "ナチュラルは飲んだことあるけど、アナロビックは飲んだことあるかわかんないな",
    },
    {
      role: "user",
      text: "こんな感じかな、また今度ログにしよう",
    },
    {
      role: "user",
      text: "あ、豆もたくさん売ってて今回は値段とか見れなかったけど、買ってもいいかも。職場からも近いし、また行きたいね、いろいろ試したいし",
    },
    {
      role: "user",
      text: "なんか最近、この国だからこの味って感じでもないなと思って、まあサンプルが少ないからかもだけど、",
    },
    {
      role: "user",
      text: "コバートはメロンね、オブスキュアがチョコ果実、で好みはやっぱあの果実の後にナッツみたいなのがすごく好きだった",
    },
    {
      role: "user",
      text: "少しブレンドにも興味が出てきたかも、普通のスタンダードていうよりか、そういう展開のあるやつ",
    },
    {
      role: "user",
      text: "BASEでオンラインショップもあり\n豆が150gで2500円くらいか、ちょい高めかな",
    },
  ],
